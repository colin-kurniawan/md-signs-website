...
const images = [truck, truck, truck, truck, truck];
      ...
      <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 flex flex-col z-10" style={{ fontFamily: 'sans-serif, Orbitron', fontSize: '6rem' }}>
        ...
        <div className="flex justify-center items-center m-3">
          <p className="text-lg md:text-xl text-white font-medium">
            Your sign better be <span className="text-[#00BCD4]"><strong>CUT OUT</strong></span> for it
          </p>
        </div>
        <div className="flex justify-center items-center m-3">
          <button className="bg-[#00BCD4] rounded-3xl text-white w-[200px] h-[50px] text-2xl font-bold hover:bg-blue-300 transition-all duration-300">Get Quote</button>
        </div>
      </div>
    </div>
  );
